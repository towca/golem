...
class RaspaTaskDefaults(TaskDefaults):
    """ Suggested default values for raspa task"""

    def __init__(self):
        super(RaspaTaskDefaults, self).__init__()
        self.options = RaspaTaskOptions()
        ...
        self.code_dir = os.path.join(get_golem_path(),
                                     "apps", "raspa", "resources", "code_dir")


class RaspaTaskDefinition(TaskDefinition):
    ...
    def set_defaults(self, defaults: RaspaTaskDefaults):
...
class RaspaTaskOptions(Options):
    def __init__(self):
        super(RaspaTaskOptions, self).__init__()
        self.environment = RaspaTaskEnvironment()